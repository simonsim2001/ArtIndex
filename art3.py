...
def plot_cumulative_returns(metrics, artprice_index=None):
    ...
    fig.add_trace(go.Scatter(x=art_cumulative.index, y=art_cumulative, mode='lines', name='Arte Blue Chip Index', line=dict(color='blue')))
    ...
    fig.add_trace(go.Scatter(x=market_cumulative.index, y=market_cumulative, mode='lines', name='Combined Market for Selected Tickers', line=dict(color='red')))
    fig.add_trace(go.Scatter(x=combined_cumulative.index, y=combined_cumulative, mode='lines', name='Combined Tickers & Arte Blue Chip Index', line=dict(color='green')))
