...
def plot_efficient_frontier(metrics):
    ...
    # Plot the Efficient Frontier as a line in grey (combined color)
    fig.add_trace(go.Scatter(
    ...
    # Plot the 100% Art portfolio point
    art_portfolio = portfolios[portfolios['Art_Weight'] == 1.0]
    fig.add_trace(go.Scatter(
        x=art_portfolio['Volatility'],
        y=art_portfolio['Expected_Return'],
        mode='markers',
        marker=dict(color=colors['art'], size=10, symbol='circle'),
        name='100% Art Portfolio'
    ))
    
    # Plot the 100% Market portfolio point
    market_portfolio = portfolios[portfolios['Art_Weight'] == 0.0]
    fig.add_trace(go.Scatter(
        x=market_portfolio['Volatility'],
        y=market_portfolio['Expected_Return'],
        mode='markers',
        marker=dict(color=colors['market'], size=10, symbol='square'),
        name='100% Market Portfolio'
    ))
